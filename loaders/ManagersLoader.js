...
const MongoLoader = require('../loaders/MongoLoader.js');
...
module.exports = class ManagersLoader {
  ...
  load() {
    ...
    // Challenge domain managers
    this.managers.auth = new AuthManager({ ...this.injectable, managers: this.managers });
    this.managers.school = new SchoolManager({ ...this.injectable, managers: this.managers });
    this.managers.classroom = new ClassroomManager({ ...this.injectable, managers: this.managers });
    this.managers.student = new StudentManager({ ...this.injectable, managers: this.managers });
    this.managers.restApi = new RestApiManager({ ...this.injectable, managers: this.managers });
